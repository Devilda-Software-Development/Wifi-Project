        ...
        <div class="row">
                        ...
                        <div class="row align-items-center">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap">
                                            <div
                                                ...
                                                <img alt="image" class="img-fluid"
                                                    src="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/order1.gif') }}" />
                                            </div>
                            ...
                            <div class="col-sm-6 cart-side-card mt-3 mt-sm-0">
                                ...
                                <p class="f-w-500 mb-0 txt-ellipsis-1">
                                    Support:
                                    <a href="%7b%7broute(%27email.html"
                                        class="link-primary text-d-underline">https://support.aicom.com/order?r72qU2892</a>
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="timeline-content p-0">
                                    <div>
                                        ...
                                        <p class="mb-0 text-dark-800 f-w-400">
                                            Feb 14/25
                                            <span class="text-primary f-w-500">10:15 AM</span>
                                        </p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="side-timeline-section w-100 right-side complete-step">
                                ...
                                <div class="timeline-content p-0">
                                    <div>
                                        ...
                                        <p class="mb-0 text-dark-800 f-w-400">
                                            Feb 14/25
                                            <span class="text-primary f-w-500">10:30 AM</span>
                                        </p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="side-timeline-section w-100 right-side">
                                ...
                                <div class="timeline-content p-0">
                                    <div>
                                        ...
                                        <p class="mb-0 text-dark-800 f-w-400">
                                            Feb 15/25
                                            <span class="text-primary f-w-500">9:00 AM</span>
                                        </p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="side-timeline-section w-100 right-side">
                                ...
                                <div class="timeline-content p-0">
                                    <div>
                                        ...
                                        <p class="mb-0 text-dark-800 f-w-400">
                                            Feb 18/25
                                            <span class="text-primary f-w-500">3:45 PM</span>
                                        </p>
                                    </div>
                                </div>
                            </li>
            ...
            <div class="col-sm-7 col-lg-4 col-xxl-3">
                <ul class="notifications-list box-list mb-4">
                    <li class="d-flex align-items-center justify-content-between gap-3 b-s-4-primary">
                        ...
                        <div
                            class="h-45 w-45 d-flex-center rounded-circle flex-shrink-0 bg-light-primary position-relative">
                    ...
                    <li class="d-flex align-items-center">
                        <div class="h-45 w-45 d-flex-center b-r-12 overflow-hidden flex-shrink-0 bg-success-400">
                            <img alt="order" class="img-fluid" src="{{ asset('admin/assets/images/avatar/2.png') }}" />
                        </div>
                        <div class="ms-3">
                            <p class="mb-0 f-w-500 f-s-16 txt-ellipsis-1">
                                Order #1024 has been shipped
                            </p>
                    ...
                    <li class="d-flex align-items-center">
                        <div class="h-45 w-45 d-flex-center b-r-12 overflow-hidden flex-shrink-0 bg-danger-400">
                            <img alt="order" class="img-fluid" src="{{ asset('admin/assets/images/avatar/5.png') }}" />
                        </div>
                        <div class="ms-3">
                            <p class="mb-0 f-w-500 f-s-16 txt-ellipsis-1">
                                Order #1022 has been canceled
                            </p>
                    ...
                    <div class="card-body p-0">
                        <div class="px-4 py-3">
                            ...
                            <p class="mb-0 text-secondary">
                                <span class="text-light-danger">38.3%-</span> Last
                                week
                            </p>
                        </div>
                ...
                <ul class="box-list mb-4">
                    ...
                    <li class="d-flex align-items-center justify-between gap-2">
                        <div
                            ...
                            <img alt="Smart Watch" class="img-fluid"
                                src="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/02.png') }}" />
                        </div>
                    ...
                    <li class="d-flex align-items-center justify-between gap-2">
                        <div
                            class="b-1-light bg-primary-200 p-1 h-40 w-40 d-flex-center b-r-12 flex-shrink-0 overflow-hidden box-list-img">
                            <img alt="Smart Watch" class="img-fluid"
                                src="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/03.png') }}" />
                        </div>
                        <div class="mg-s-45 flex-grow-1">
                            <h6 class="mb-0 text-dark-800 f-w-500 txt-ellipsis-1">
                                Digital Camera
                    ...
                    <li class="d-flex align-items-center justify-between gap-2">
                        <div
                            class="b-1-light bg-primary-200 p-1 h-40 w-40 d-flex-center b-r-12 flex-shrink-0 overflow-hidden box-list-img">
                            <img alt="Smart Watch" class="img-fluid"
                                src="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/01.png') }}" />
                        </div>
                ...
                <ul class="list-box top-brand-list mb-4">
                    ...
                    <li class="d-flex align-items-center">
                        <div
                            class="b-1-light bg-primary-200 p-1 h-40 w-40 d-flex-center b-r-12 flex-shrink-0 overflow-hidden box-list-img">
                            <img alt="Smart Watch" class="img-fluid"
                                src="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/04.png') }}" />
                        </div>
                    ...
                    <li class="d-flex align-items-center">
                        <div
                            class="b-1-light bg-primary-200 p-1 h-40 w-40 d-flex-center b-r-12 flex-shrink-0 overflow-hidden box-list-img">
                            <img alt="Smart Watch" class="img-fluid"
                                src="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/06.png') }}" />
                        </div>
                        <div class="flex-grow-1 mg-s-45">
                            <h6 class="mb-0 f-w-500 text-dark-800 txt-ellipsis-1">
                                Techspire
                    ...
                    <li class="d-flex align-items-center">
                        <div
                            class="b-1-light bg-primary-200 p-1 h-40 w-40 d-flex-center b-r-12 flex-shrink-0 overflow-hidden box-list-img">
                            <img alt="Smart Watch" class="img-fluid"
                                src="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/07.png') }}" />
                        </div>
                        <div class="flex-grow-1 mg-s-45">
                            <h6 class="mb-0 f-w-500 text-dark-800 txt-ellipsis-1">
                                TrekVibe
                    ...
                    <div class="card-body offer-card-body overflow-hidden">
                        <div>
                            ...
                            <h5 class="text-white mt-4">
                                Super
                                <span class="text-bg-primary p-1 f-s-26 f-w-700">Kids’</span>
                                Weekend <br />
                        ...
                        <div>
                            ...
                            <a class="f-s-12 f-w-500 text-white text-d-underline" href="#">Minimum purchase of $30
                                required. Online &
                                in-store.</a>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-md-4 col-xxl-2 order-3-md">
                <div class="card service-trial-card">
                    <div class="card-body">
                        <h5 class="text-white f-w-600 txt-ellipsis-1">
                            AI Commerce
                        </h5>
                        <p class="text-white mt-2 txt-ellipsis-2">
                            Smarter Shopping, Faster Growth
                        </p>
                        <div class="service-img-box"></div>
                        <div class="mt-3">
                            <a href="chat.html" target="_blank" class="btn btn-primary btn-sm w-100 text-nowrap">Start
                                Free Trial</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body pb-0">
                        <div class="mb-2">
                            <h4 class="text-primary">
                                98.65%
                                <span class="f-s-14 text-dark">Total sale</span>
                            </h4>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="row g-2 h-100">
                                    <div class="col-6">
                                        <a href="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/product-01.jpg') }}"
                                            class="glightbox brand-img-box" data-glightbox="type: image; zoomable: true;">
                                            <img src="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/product-01.jpg') }}"
                                                class="w-100" alt="..." />
                                        </a>
                                    </div>
                                    <div class="col-6 position-relative">
                                        ...
                                        <a href="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/product-02.jpg') }}"
                                            class="glightbox brand-img-box" data-glightbox="type: image;">
                                            <img src="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/product-02.jpg') }}"
                                                class="w-100" alt="..." />
                                        </a>
                                    </div>
                                    <div class="col-3">
                                        <a href="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/product-03.jpg') }}"
                                            class="glightbox brand-img-box" data-glightbox="type: image;">
                                            <img src="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/product-03.jpg') }}"
                                                class="w-100" alt="..." />
                                        </a>
                                    </div>
                                    <div class="col-3">
                                        <a href="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/product-04.jpg') }}"
                                            class="glightbox brand-img-box" data-glightbox="type: image;">
                                            <img src="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/product-04.jpg') }}"
                                                class="w-100" alt="..." />
                                        </a>
                                    </div>
                                    <div class="col-3">
                                        <a href="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/product-05.jpg') }}"
                                            class="glightbox brand-img-box" data-glightbox="type: image;">
                                            <img src="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/product-05.jpg') }}"
                                                class="w-100" alt="..." />
                                        </a>
                                    </div>
                                    <div class="col-3">
                                        <a href="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/product-06.jpg') }}"
                                            class="glightbox brand-img-box" data-glightbox="type: image;">
                                            <img src="{{ asset('admin/assets/images/dashboard/ecommerce-dashboard/product/product-06.jpg') }}"
                            ...
                            <div class="col-sm-7">
                                <div class="my-3">
                                    <h3 class="text-dark-800 f-w-700 txt-ellipsis-1">
                                        $58,902.90
                                        <span class="f-s-16 f-w-500 text-secondary">Last week</span>
                                    </h3>
